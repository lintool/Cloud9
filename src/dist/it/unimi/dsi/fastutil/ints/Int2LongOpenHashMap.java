...
public class Int2LongOpenHashMap extends AbstractInt2LongMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Int2LongOpenHashMap( final int n, final float f ) {
 ...
 /** Creates a new hash map with {@link Hash#DEFAULT_LOAD_FACTOR} as load factor.
	 ...
	 * @param n the expected number of elements in the hash map.
	 */
 public Int2LongOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  int c = count;
  {
   final byte state[] = Int2LongOpenHashMap.this.state;
   final int n = state.length;
   if ( c != 0 ) while( pos < n && state[ pos ] != OCCUPIED ) pos++;
  }
  public boolean hasNext() {
   return c != 0 && pos < Int2LongOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Integer, Long> e = (Map.Entry<Integer, Long>)o;
   final int i = findKey( ((e.getKey()).intValue()) );
   if ( i >= 0 ) Int2LongOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
  public int size() {
   return count;
