...
public class Int2FloatOpenHashMap extends AbstractInt2FloatMap implements java.io.Serializable, Cloneable, Hash {
 ...
 public Int2FloatOpenHashMap( final int n, final float f ) {
 ...
 /** Creates a new hash map with {@link Hash#DEFAULT_LOAD_FACTOR} as load factor.
	 ...
	 * @param n the expected number of elements in the hash map.
	 */
 public Int2FloatOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  int c = count;
  {
   final byte state[] = Int2FloatOpenHashMap.this.state;
   final int n = state.length;
   if ( c != 0 ) while( pos < n && state[ pos ] != OCCUPIED ) pos++;
  }
  public boolean hasNext() {
   return c != 0 && pos < Int2FloatOpenHashMap.this.state.length;
  }
 ...
 public Float get(final Integer ok) {
  ...
  return i < 0 ? (null) : (Float)(Float.valueOf(value[i]));
 }
 @SuppressWarnings("unchecked")
 ...
 private final class MapEntrySet extends AbstractObjectSet<Int2FloatMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<Integer, Float> e = (Map.Entry<Integer, Float>)o;
   final int i = findKey( ((e.getKey()).intValue()) );
   if ( i >= 0 ) Int2FloatOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
  public int size() {
   return count;
