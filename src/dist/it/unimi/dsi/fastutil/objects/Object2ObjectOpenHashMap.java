...
public class Object2ObjectOpenHashMap <K,V> extends AbstractObject2ObjectMap <K,V> implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  int c = count;
  {
   final byte state[] = Object2ObjectOpenHashMap.this.state;
   final int n = state.length;
   if ( c != 0 ) while( pos < n && state[ pos ] != OCCUPIED ) pos++;
  }
  public boolean hasNext() {
   return c != 0 && pos < Object2ObjectOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry <K,V> > implements FastEntrySet <K,V> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, V> e = (Map.Entry<K, V>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2ObjectOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
  public int size() {
   return count;
