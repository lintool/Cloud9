...
public class Object2IntOpenHashMap <K> extends AbstractObject2IntMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  int c = count;
  {
   final byte state[] = Object2IntOpenHashMap.this.state;
   final int n = state.length;
   if ( c != 0 ) while( pos < n && state[ pos ] != OCCUPIED ) pos++;
  }
  public boolean hasNext() {
   return c != 0 && pos < Object2IntOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Integer> e = (Map.Entry<K, Integer>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2IntOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
  public int size() {
   return count;
