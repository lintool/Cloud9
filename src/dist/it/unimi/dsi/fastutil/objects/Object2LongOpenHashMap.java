...
public class Object2LongOpenHashMap <K> extends AbstractObject2LongMap <K> implements java.io.Serializable, Cloneable, Hash {
 ...
 public Object2LongOpenHashMap( final int n, final float f ) {
 ...
 /** Creates a new hash map with {@link Hash#DEFAULT_LOAD_FACTOR} as load factor.
	 ...
	 * @param n the expected number of elements in the hash map.
	 */
 public Object2LongOpenHashMap( final int n ) {
 ...
 private class MapIterator {
  ...
  int c = count;
  {
   final byte state[] = Object2LongOpenHashMap.this.state;
   final int n = state.length;
   if ( c != 0 ) while( pos < n && state[ pos ] != OCCUPIED ) pos++;
  }
  public boolean hasNext() {
   return c != 0 && pos < Object2LongOpenHashMap.this.state.length;
  }
 ...
 private final class MapEntrySet extends AbstractObjectSet<Object2LongMap.Entry <K> > implements FastEntrySet <K> {
  ...
  public boolean remove( final Object o ) {
   ...
   final Map.Entry<K, Long> e = (Map.Entry<K, Long>)o;
   final int i = findKey( (e.getKey()) );
   if ( i >= 0 ) Object2LongOpenHashMap.this.remove( e.getKey() );
   return i >= 0;
  }
  public int size() {
   return count;
