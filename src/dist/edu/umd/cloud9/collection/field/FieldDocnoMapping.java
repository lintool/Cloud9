 ...
 * @author Nima Asadi
 */
public class FieldDocnoMapping implements DocnoMapping {

  private static final Logger sLogger = Logger.getLogger(FieldDocnoMapping.class);

  private String[] mDocids;

  /**
   * Creates a <code>FieldDocnoMapping</code> object
   */
  public FieldDocnoMapping() {
  }
  ...
  public static void main(String[] args) throws IOException {
    ...
    FieldDocnoMapping mapping = new FieldDocnoMapping();
