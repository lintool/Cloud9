...
/**
 * <p>
 * Program to uncompress the Wt10g collection from the original distribution and
...
public class RepackWt10gDocuments extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new RepackWt10gDocuments(), args);
		System.exit(res);
	}
