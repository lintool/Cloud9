...
public interface MapIL {
  ...
  /**
   * A map entry (key-value pair) for <tt>MapIL</tt>. The <tt>MapIL.entrySet</tt> method returns a
   ...
   * <tt>MapIL.Entry</tt> objects are valid <i>only</i> for the duration of the iteration; more
   ...
   * works properly across different implementations of the <tt>MapIL</tt> interface.
   *
