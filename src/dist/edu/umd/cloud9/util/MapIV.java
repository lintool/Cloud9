...
public interface MapIV<V> {
	...
	/**
	 * A map entry (key-value pair) for <tt>MapIK</tt>. The
	 * <tt>MapIK.entrySet</tt> method returns a collection-view of the map,
	 ...
	 * These <tt>MapIK.Entry</tt> objects are valid <i>only</i> for the
