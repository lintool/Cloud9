...
public class GenericDriver extends Configured implements Tool
{
	...
	while (argc > 0)
	{
		...
		{
		    System.out
			    .println("Insufficient arguments, more arguments needed.");
		    return false;
		}
		argc--;
		...
		{
		    System.out
			    .println("Invalid arguments, Integer is expected after -ls flag.");
		    return false;
		}
	    }
