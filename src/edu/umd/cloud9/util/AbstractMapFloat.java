...
import edu.umd.cloud9.util.MapFloat.Entry;
...
public abstract class AbstractMapFloat<K> implements MapFloat<K> {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected AbstractMapFloat() {
    }
	...
	Iterator<MapFloat.Entry<K>> i = entrySet().iterator();
	if (key==null) {
	    while (i.hasNext()) {
		Entry<K> e = i.next();
		if (e.getKey()==null)
    ...
    public void putAll(MapFloat<? extends K> m) {
        for (MapFloat.Entry<? extends K> e : m.entrySet())
	...
	if (keySet == null) {
		...
		public int size() {
		    return AbstractMapFloat.this.size();
		}

		public boolean contains(Object k) {
		    return AbstractMapFloat.this.containsKey(k);
		}
	    };
	}
	return keySet;
	...
	if (values == null) {
		...
		public boolean contains(float v) {
		    return AbstractMapFloat.this.containsValue(v);
		}
	    };
	}
	return values;
	...
	if (!(o instanceof MapFloat))
	    return false;
	MapFloat<K> m = (MapFloat<K>) o;
	if (m.size() != size())
	    return false;
    ...
    protected Object clone() throws CloneNotSupportedException {
        AbstractMapFloat<K> result = (AbstractMapFloat<K>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
     ...
     * @since 1.6
     */
    public static class SimpleEntry<K>
	implements Entry<K>, java.io.Serializable
    {
	 ...
	 */
	public boolean equals(Object o) {
	    if (!(o instanceof MapFloat.Entry))
		return false;
	    MapFloat.Entry e = (MapFloat.Entry)o;
     ...
     * @since 1.6
     */
    public static class SimpleImmutableEntry<K>
	implements Entry<K>, java.io.Serializable
    {
	...
	private final float value;
         ...
         * @param value the value represented by this entry
         */
	public SimpleImmutableEntry(K key, float value) {
	    this.key   = key;
            this.value = value;
	}
