 ...
 * <tt>equals</tt> and <tt>hashCode</tt> methods are no longer well defined
 * on such a map.
 * 
 * <p>
 ...
 * and a constructor with a single argument of type <tt>Map</tt>, which
 ...
 * throw an <tt>UnsupportedOperationException</tt> if the invocation would
 ...
 * to query the presence of an ineligible key or value may throw an exception,
 ...
 * <tt>k</tt> such that <tt>(key==null ? k==null : key.equals(k))</tt>."
 ...
 * <tt>key.equals(k)</tt> to be invoked for any key <tt>k</tt>.
 ...
 * hash codes of the two keys. (The {@link Object#hashCode()} specification
...
public interface MapIF {
	 ...
	 *         associated <tt>null</tt> with <tt>key</tt>, if the
