...
public class EntryObject2IntFrequencyDistributionTest {

	@Test
	public void test1() {
		Object2IntFrequencyDistribution<String> fd = new EntryObject2IntFrequencyDistribution<String>();
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(EntryObject2IntFrequencyDistributionTest.class);
	}
}