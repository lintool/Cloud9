...
import edu.umd.cloud9.util.count.OpenObject2IntConditionalFrequencyDistribution;
...
public class OpenConditionalFrequencyDistributionTest {
	...
	@Test
	public void test1() {
		OpenObject2IntConditionalFrequencyDistribution<String> cdf = new OpenObject2IntConditionalFrequencyDistribution<String>();
