...
public class OpenObject2LongFrequencyDistributionTest {
	...
	@Test
	public void test1() {
		OpenObject2LongFrequencyDistribution<String> fd = new OpenObject2LongFrequencyDistribution<String>();
	...
	@Test
	public void test3() {
		Object2LongFrequencyDistribution<String> fd = new OpenObject2LongFrequencyDistribution<String>();
	...
	public void testGetSortedEvents() {
		...
		List<PairOfObjectLong<String>> list = fd.getEntries(Order.ByLeftElementDescending);
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(OpenObject2LongFrequencyDistributionTest.class);
	}
}
