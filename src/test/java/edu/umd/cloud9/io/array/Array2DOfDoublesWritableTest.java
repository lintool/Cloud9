...
public class Array2DOfDoublesWritableTest {
  ...
  public void testBasic() throws IOException {
    double ia[][] = { { 1, 2, 4, 5 }, { 3 }, null };

    Array2DOfDoublesWritable array2D = new Array2DOfDoublesWritable(ia);
  ...
  public void testSerialize1() throws IOException {
    ...
    Array2DOfDoublesWritable array2DA = new Array2DOfDoublesWritable(ia);
    ByteArrayOutputStream bytesOut = new ByteArrayOutputStream();
    DataOutputStream dataOut = new DataOutputStream(bytesOut);
    array2DA.write(dataOut);
    Array2DOfDoublesWritable array2DB = new Array2DOfDoublesWritable();
